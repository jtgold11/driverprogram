...
// Redirect to cart page if they've submitted the form.
if (isset($_GET["sponsorId"])) {
    header("Location: cartCheckoutPage.php?sponsorId={$_GET["sponsorId"]}");
    exit;
}
...
<head>
    <title>Select Sponsor's Page</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container text-center">
        <form action="cartSponsorSelect.php" method="GET">
            <fieldset>
                <legend>Select which sponsor's cart to view.</legend>
